...
distribution  = Job.create(
  ...
  helper: "Sadie",
  chart_id: girl_scout.id)
bonatist = Job.create(title: "Botanist",
  image_url: "https://lh3.googleusercontent.com/proxy/n4k_6svZ3vqGdjAbuVkMe6Cgs4ynT6ygurq4_y8WMO5AvinU34kb7YZfXskkdM7qRcce7R5N9v30rJOqS5nkr_a2MgINQuPQ66YzGYa3ndNqBg",
  description: "I can water the plants.",
  helper: "Abigail",
  chart_id: girl_scout.id)
